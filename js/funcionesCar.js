...
function getCar(){
    $.ajax({
        url:"http://138.2.225.157:8080/api/Car/all",
        type:"GET",
        datatype:"JSON",
...
function postCar(){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://138.2.225.157:8080/api/Car/save",
        type:"POST",
        datatype:"JSON",
...
$.ajax({
    url:"http://138.2.225.157:8080/api/Car/update",
    type:"PUT",
    datatype:"JSON",
...
function deleteCar(idBoton){
    ...
    $.ajax({
        url:"http://138.2.225.157:8080/api/Car/"+idBoton,
        type:"DELETE",
        datatype:"JSON",
